  ...
  */
  public function login() {
    ...
    if ($this->form_validation->run() === TRUE) {
      ...
      // set the flash data error message if there is one
      $this->data['message_success'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
      $this->data['message_errors'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('errors');
  ...
  */
  public function forgot_password() {
    ...
    if ($this->form_validation->run() === FALSE) {
      ...
      $this->data['message_sucess'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
      $this->data['message_errors'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('errors');
  ...
  */
  public function register() {
    ...
    if ($this->form_validation->run() === TRUE && $this->ion_auth->register($identity, $password, $email, $additional_data)) {
      ...
      // set the flash data error message if there is one
      $this->data['message_success'] = (validation_errors() ? validation_errors() : ($this->ion_auth->errors() ? $this->ion_auth->errors() : $this->session->flashdata('message')));
