      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="<?= base_url(); ?>"><i class="fa fa-fire"></i> <span>Dashboard</span></a></li>

            <li class="menu-header">Main Menu</li>
            <?php $menu = $this->db->order_by('order', 'ASC')->get_where('menu', array('is_parent' => 0, 'is_active' => 1)); ?>
            <?php foreach ($menu->result() as $m) : ?>
              <?php $submenu = $this->db->get_where('menu', array('is_parent' => $m->id, 'is_active' => 1)); ?>
              <?php if ($submenu->num_rows() > 0) : ?>
                <?php if ($this->uri->segment(3) == $m->link) : ?>
                  <li class='nav-item dropdown active'>
                  <?php else : ?>
                  <li class='nav-item dropdown'>
                  <?php endif; ?>
                  <a href='#' class='nav-link has-dropdown' data-toggle='dropdown'><i class='<?= $m->icon; ?>'></i><span><?= ucfirst($m->name); ?></span></a>
                  <ul class='dropdown-menu'>
                    <?php foreach ($submenu->result() as $s) : ?>
                      <li><a class='nav-link' href='<?= base_url() . $s->link; ?>'><?= ucfirst($s->name) ?></a></li>
                    <?php endforeach; ?>
                  </ul>
                  </li>
                <?php else : ?>
                  <li><a class='nav-link' href='<?= base_url() . $m->link ?>' class='nav-link'><i class='<?= $m->icon; ?>'></i><span><?= ucfirst($m->name); ?></span></a></li>
              <?php endif;
            endforeach; ?>
          ...
          <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
            <a href="<?= admin_url(); ?>logout" class="btn btn-primary btn-lg btn-block btn-icon-split">
