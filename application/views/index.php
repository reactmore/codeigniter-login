            ...
            <div class="row">
                  ...
                  <div class="card-block px-0 py-3">
                    <div class="table-responsive">
                      <table class="table table-hover">
                        <tbody>
                          <tr class="unread">
                            <td><img class="rounded-circle" style="width:40px;" src="<?= base_url('assets/admin'); ?>/images/user/avatar-1.jpg" alt="activity-user"></td>
                            <td>
                          ...
                          <tr class="unread">
                            <td><img class="rounded-circle" style="width:40px;" src="<?= base_url('assets/admin'); ?>/images/user/avatar-2.jpg" alt="activity-user"></td>
                            <td>
                          ...
                          <tr class="unread">
                            <td><img class="rounded-circle" style="width:40px;" src="<?= base_url('assets/admin'); ?>/images/user/avatar-3.jpg" alt="activity-user"></td>
                            <td>
              ...
              <div class="col-xl-8 col-md-12 m-b-30">
                ...
                <div class="tab-content" id="myTabContent">
                  <div class="tab-pane table-responsive fade" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <table class="table table-hover">
                      <thead>
                        <tr>
                          <th>User</th>
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <h6 class="m-0"><img class="rounded-circle m-r-10" style="width:40px;" src="<?= base_url('assets/admin'); ?>/images/user/avatar-1.jpg" alt="activity-user">Ida Jorgensen</h6>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="<?= base_url('assets/admin'); ?>/images/user/avatar-2.jpg" alt="activity-user">Albert Andersen</h6>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="<?= base_url('assets/admin'); ?>/images/user/avatar-3.jpg" alt="activity-user">Silje Larsen</h6>
                          </td>
                          <td>
                  ...
                  <div class="tab-pane fade active show table-responsive" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <table class="table table-hover">
                      <thead>
                        <tr>
                          <th>User</th>
